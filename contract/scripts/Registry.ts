...
import {NFTAddress, RegistryAddress, ERC6551AccountAddress, UsdcABI} from '../deployments/buildbear';
...
async function main() {
  ...
  const ERC6551Account = await ethers.getContractAt('ERC6551Account', ERC6551AccountAddress);
