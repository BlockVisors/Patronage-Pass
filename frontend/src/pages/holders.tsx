  ...
  return (
    <Layout title="Holders Only Area" className="">
      <section className="hero">
        <h1>Patronage Pass Perks</h1>
        <p>
          This page only shows content to users with a Patronage Pass NFT. The Patronage,
        is&apos;re exploring a large number of tokenized experiences with partner firms.{" "}
          <a
              ...
              {user?.collectibles?.length > 0 ? (
                <div>
                  <p className="mx-auto max-w-5xl">
                    Everyone loves to be included. Complete the form below to stay informed
                    !
                  </p>
